...
check "symlink: .shrc"                test -L "$FAKE_HOME/.shrc"
...
check "symlink: .claude/CLAUDE.md"    test -L "$FAKE_HOME/.claude/CLAUDE.md"
check "symlink: .claude/skills/backlog" test -L "$FAKE_HOME/.claude/skills/backlog"
